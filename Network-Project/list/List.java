...
public abstract class List {
  ...
  public abstract ListNode back();
   ...
   /**
   *  has() returns a boolean representing if an item is in a List.
   *  @param item is the item that we are looking for in the list.
   *  @return a boolean that is true is the item is in the list and false if otherwise.
   */
  public abstract boolean has(Object item);
